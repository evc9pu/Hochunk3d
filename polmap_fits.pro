...
dir='../models/modcI/'
file1=dir+'e_2H_80.0_0.0_I_img.fits.gz'
file2=dir+'e_2H_80.0_0.0_Q_img.fits.gz'
file3=dir+'e_2H_80.0_0.0_U_img.fits.gz'
smoothwidth=5   ;modify as desired

!p.multi=[0,1,1]

;number of contour levels to plot
nlev=10  ;plots contours in half-mag intervals
...
rmaxi=fxpar(headi,'RMAXI')
rmaxi=rmaxi/1.49598e13
pixsize=2.*rmaxi/float(nx2)
