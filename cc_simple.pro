...
;filename='cc.ps'
filename='cc.eps',/encapsulated,/CMYK
...
;readcol,'filter_AeBe_env_nopah.txt',cosi,phi,j,h,k,b1,b2,b3,b4,b5,b6,b7,skipline=2
;readcol,'filter_hmpo.txt',cosi,phi,j,h,k,b1,b2,b3,b4,b5,b6,b7,skipline=2
...
;plotcol_simp,d,b3-b4,b1-b2,cosi,'[5.8]-[8.0]','[3.6]-[4.5]',-.0,2.,0.,2.0,ninc,0,ccol,circ
plotcol_simp,d,b3-b4,b1-b2,cosi,'[5.8]-[8.0]','[3.6]-[4.5]',0.5,3.5,0.,1.5,ninc,0,ccol,circ
...
;readcol,'filter_hmpo_pah.txt',cosi,phi,j,h,k,b1,b2,b3,b4,b5,b6,b7,skipline=2
...
circ='fill'
op=1 ; overplot
plotcol_simp,d,b3-b4,b1-b2,cosi,'[5.8]-[8.0]','[3.6]-[4.5]',-.5,2.0,-.5,4,ninc,op,ccol,circ
